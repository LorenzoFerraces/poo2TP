...
class FiltroSaleEnTest {
	...
	void seDebeObtenerElTiempoDeViajeEntreLaTerminalOrigenYLaTerminalGestionada() {
		...
		//
		this.filtro = new FiltroSaleEn(mock(LocalDateTime.class), this.terminal2, List.of(this.viaje1));
		filtro.filtrar();
	...
	void seObtienenSoloLosCircuitosQueCoincidanConLaFechaDeSalida() {
		...
		this.filtro = new FiltroSaleEn(fechaEsperada, this.terminal1, List.of(this.viaje1, this.viaje2, this.viaje3));
